...
Feature: This feature tests the icon text in AEM authoring and storybook

  @TestAuthoringIconText-p3
  @AuthoringRegression1-p3.chrome.desktop
  @AuthoringSanity-p3.chrome.desktop
  @AnalyticsAttributesAuthoring-p3
  Scenario: Verify user is able to author icon text component and verify published dispatcher component, accessibility and visually
    #launch AEM
    ...
    #Enter page title
    And I enter "test-automation-icon-text-RANDOM[0-8]-p3" details in "pageTitleInputBox" on "aemCreatePageWizard" screen
    ...
    And I capture the address navigated to
    And I take a screenshot
    And I check the page address contains "/content/racv/en/home/racv-home/utility/qa/test-automation-icon-text-RANDOM[0-8]-p3.html"
    ...
    Then I click "iconType" on "aemIconTextComponentDialog" screen
    And I select "Car" value for "iconTypeList" drop down in "aemIconTextComponentDialog" screen using selection method "visibleText"
    And I take a screenshot
    And I click "iconPlace" on "aemIconTextComponentDialog" screen
    And I select "Left" value for "iconPlaceList" drop down in "aemIconTextComponentDialog" screen using selection method "visibleText"
    And I take a screenshot
    And I click "leftIconTheme" on "aemIconTextComponentDialog" screen
    And I select "Product" value for "leftIconThemeList" drop down in "aemIconTextComponentDialog" screen using selection method "visibleText"
    And I take a screenshot
    ...
    And I take a screenshot
    And I click "iconPlace" on "aemIconTextComponentDialog" screen
    And I select "Top" value for "iconPlaceList" drop down in "aemIconTextComponentDialog" screen using selection method "visibleText"
    And I click "topIconAlignment" on "aemIconTextComponentDialog" screen
    And I select "Left Align" value for "topIconAlignmentList" drop down in "aemIconTextComponentDialog" screen using selection method "visibleText"
    And I take a screenshot
    ...
    And I select "Top" value for "iconPlaceList" drop down in "aemIconTextComponentDialog" screen using selection method "visibleText"
    And I click "topIconAlignment" on "aemIconTextComponentDialog" screen
    And I select "Center Align" value for "topIconAlignmentList" drop down in "aemIconTextComponentDialog" screen using selection method "visibleText"
    And I take a screenshot
    ...
    And I take a screenshot
    And I navigate to "URL/racv-home/utility/qa/test-automation-icon-text-RANDOM[0-8]-p3.html"
    #Post publish checks
    ...
    When I navigate to "URL/racv-home/utility/qa/test-automation-icon-text-RANDOM[0-8]-p3.html"
  ...
  @TestPublishIconText-p3
  #@Regression-p3.chrome.desktop
  @PublishRegression-p3.chrome.desktop
  Scenario Outline: Accordion post publish checks on <theme> theme
    Given I launch app page "URL/racv-home/utility/qa/all-components/<theme>/test-automation-icon-text-p3.html"
    #Post publish checks
    And I wait for "iconText1" on "aemTestIconTextPublished" screen or "10" seconds before proceeding
    And I dismiss GDPR notification if it exists
    And I verify "iconText1" element exists on "aemTestIconTextPublished" screen
    ...
    And I capture the address navigated to
    And I check the page address contains "/cars-transport.html"
    When I navigate to "URL/racv-home/utility/qa/all-components/<theme>/test-automation-icon-text-p3.html"
    Then I verify "iconText2" element exists on "aemTestIconTextPublished" screen
    #Verify analytics attributes on linkInIconText2
    And I verify "data-event" attribute is "site interaction" on "linkInIconText2" element on "aemTestIconTextPublished" screen
    And I verify "data-type" attribute is "link" on "linkInIconText2" element on "aemTestIconTextPublished" screen
  ...
  Scenario: Verify Icon Text page in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=&id=templates--icon-text-page&viewMode=story"
    And I dismiss GDPR notification if it exists
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextTopLeft
  @Storybook-regression-p3.chrome.desktop
  @Storybook-regression-p3-base.chrome.desktop
  Scenario: Verify Icon Text top left in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=&id=components-icon-text--icon-text-top-story&viewMode=story"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextTopCenter
  @Storybook-regression-p3.chrome.desktop
  @Storybook-regression-p3-base.chrome.desktop
  Scenario: Verify Icon Text top center in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=Content_Alignment:center-align&id=components-icon-text--icon-text-top-story&viewMode=story"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextLeftInterface
  @Storybook-regression-p3.chrome.desktop
  @Storybook-regression-p3-base.chrome.desktop
  Scenario: Verify Icon Text left interface in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=Theme:interface&id=components-icon-text--icon-text-left-story&viewMode=story"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextLeftIllustrative
  @Storybook-regression-p3.chrome.desktop
  @Storybook-regression-p3-base.chrome.desktop
  Scenario: Verify Icon Text left illustrative in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=&id=components-icon-text--icon-text-left-story&viewMode=story"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextLeftProduct
  @Storybook-regression-p3.chrome.desktop
  @Storybook-regression-p3-base.chrome.desktop
  Scenario: Verify Icon Text left product in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=Theme:product&id=components-icon-text--icon-text-left-story&viewMode=story"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextLeftInformative
  @Storybook-regression-p3.chrome.desktop
  @Storybook-regression-p3-base.chrome.desktop
  Scenario: Verify Icon Text left informative in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=Theme:informative&id=components-icon-text--icon-text-left-story&viewMode=story"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextPage
  @Storybook-regression-p3-club.chrome.desktop
  Scenario: Verify Icon Text page (club theme) in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=&id=templates--icon-text-page&viewMode=story&globals=theme:club"
    And I dismiss GDPR notification if it exists
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"
  ...
  @TestSBIconTextTopLeft
  @Storybook-regression-p3-club.chrome.desktop
  Scenario: Verify Icon Text top left (club theme) in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=&id=components-icon-text--icon-text-top-story&viewMode=story&globals=theme:club"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextTopCenter
  @Storybook-regression-p3-club.chrome.desktop
  Scenario: Verify Icon Text top center (club theme) in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=Content_Alignment:center-align&id=components-icon-text--icon-text-top-story&viewMode=story&globals=theme:club"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextLeftInterface
  @Storybook-regression-p3-club.chrome.desktop
  Scenario: Verify Icon Text left interface (club theme) in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=Theme:interface&id=components-icon-text--icon-text-left-story&viewMode=story&globals=theme:club"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextLeftIllustrative
  @Storybook-regression-p3-club.chrome.desktop
  Scenario: Verify Icon Text left illustrative (club theme) in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=&id=components-icon-text--icon-text-left-story&viewMode=story&globals=theme:club"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextLeftProduct
  @Storybook-regression-p3-club.chrome.desktop
  Scenario: Verify Icon Text left product (club theme) in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=Theme:product&id=components-icon-text--icon-text-left-story&viewMode=story&globals=theme:club"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"

  @TestSBIconTextLeftInformative
  @Storybook-regression-p3-club.chrome.desktop
  Scenario: Verify Icon Text left informative (club theme) in storybook
    Given I launch app page "https://design-system-dev.racv.com.au/iframe.html?args=Theme:informative&id=components-icon-text--icon-text-left-story&viewMode=story&globals=theme:club"
    And I take a screenshot
    And I take a lambda snapshot "main snapshot" "hide-gdpr"